...
export default async function KaryaPage() {
  ...
  // Ambil semua data dengan kategori INNOVATION
  const res = await fetch(`${baseUrl}/api/post?category=STUDENT_WORK`, {
    cache: 'no-store'
  });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
            Eksplorasi seluruh hasil karya dan kreativitas terbaik dari siswa-siswi kami.
          </p>
        ...
        {posts && posts.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
            <p className="text-slate-500">Tidak ada data karya yang ditemukan.</p>
          </div>
        )}
      </div>
    </main>
