    ...
    if (!post) {
      return (
        <div className="p-20 text-center">
          ...
          <a href="/karya" className="text-blue-600 mt-4 inline-block"> Kembali ke Daftar Karya</a>
        </div>
      );
    }
      ...
      <article className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="mt-16 pt-8 border-t">
            <a href="/karya" className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-6 py-3 rounded-full font-semibold transition-colors">
