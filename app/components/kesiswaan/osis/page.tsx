...
export default async function OsisPage() {
    ...
    // Ambil semua data dengan kategori OSIS
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-12 text-center">
                    ...
                    <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
                        Organisasi Siswa Intra Sekolah dan Majelis Perwakilan Kelas SMANKA. Wadah kepemimpinan dan kreativitas siswa.
                    </p>
                ...
                {posts && posts.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
                        <p className="text-slate-500">Tidak ada data OSIS yang ditemukan.</p>
                    </div>
                )}
            </div>
        </main>
