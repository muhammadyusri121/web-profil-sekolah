...
export default async function DetailPaskibrakPage({ params }: { params: Promise<{ slug: string }> }) {
        ...
        if (!post) {
            return (
                <div className="min-h-screen flex flex-col items-center justify-center bg-yellow-50">
                    ...
                    <Link href="/ekskul/paskibraka" className="text-yellow-600 mt-4 font-semibold hover:underline">
                        ← Kembali
                    </Link>
                </div>
            );
