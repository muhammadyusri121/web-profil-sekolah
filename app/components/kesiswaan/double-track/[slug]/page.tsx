export default async function DetailDoubleTrackPage({ params }: { params: Promise<{ slug: string }> }) {
        ...
        if (!post) {
            return (
                <div className="p-20 text-center">
                    ...
                    <a href="/double-track" className="text-blue-600 mt-4 inline-block"> Kembali ke Daftar Double Track</a>
                </div>
            );
        }
                ...
                <div className="max-w-4xl mx-auto px-6 py-12">
                    <div className="mb-8">
                        <span className="text-blue-600 font-bold uppercase tracking-wider text-sm">
                            Kategori: {post.category || "DOUBLE_TRACK"}
                        </span>
                    ...
                    <div className="mt-16 pt-8 border-t">
                        <a href="/double-track" className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-6 py-3 rounded-full font-semibold transition-colors">
                            ← Kembali ke Semua Double Track
                        </a>
                    </div>
                </div>
            </article>
